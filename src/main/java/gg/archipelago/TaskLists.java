...
public class TaskLists {
    ...
    private static List<APTask> allTasksCached;
    public static List<APTask> GetAllTasks(String data_version){
        ...
        if (data_version.isEmpty() || locs == null){
            allTasksCached = defaultTasks;
        } else {
            allTasksCached = new ArrayList<>();
            for (LocationData loc : locs){
                allTasksCached.add(APTask.CreateFromLocationCSVRow(loc, base_id + taskCount++));
            }
        }
    ...
    public static List<LocationData> GetTaskCSVs(String dataVersion){
        if (dataVersion.isEmpty()) return null;
    ...
    public List<String> GetItemCSVs(String dataVersion){
        String taggedRepoAddress = repository_address+dataVersion;
        //Items are much simpler. We don't need anything other than a name and order. We can throw out most of the generation settings
